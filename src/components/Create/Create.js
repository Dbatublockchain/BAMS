...
const Create = () => {
    ...
    return (
        <Container style={{ paddingTop: "6.5rem" }} className="text-left">
            ...
            <Form.Group as={Row} className="mb-3" controlId="formBasicPassword">
              <Form.Label column sm="2">Number of Quantity</Form.Label>
              <Col sm="10">
              <Form.Control type="number" placeholder="e.g. 10" //value={amount} onChange={(e) => setAmount(e.target.value)}
              />
              </Col>
            </Form.Group>

            <Form.Group as={Row} className="mb-3" controlId="formBasicPassword">
              <Form.Label column sm="2">Total Cost of Purchased Items</Form.Label>
              <Col sm="10">
